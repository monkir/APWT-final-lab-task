        ...
        <nav>
            <header class="text-gray-600 body-font">
                <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <Link class="mr-5 hover:text-gray-900" href="/employee/manage-customer"> Manage Customer</Link>
                    <Link class="mr-5 hover:text-gray-900" href="/employee/manage-busowner"> Manage Bus-owner</Link>
                    <Link class="mr-5 hover:text-gray-900" href="#"> Manage Employee</Link>
                    <Link class="mr-5 hover:text-gray-900" href="/employee/signup"> Emplyee signup</Link>
                    <Link class="mr-5 hover:text-gray-900" href="/employee/login"> Emplyee login</Link>
                    {/* <Link class="mr-5 hover:text-gray-900">hi</Link>
                    <Link class="mr-5 hover:text-gray-900">hi</Link>
                    <Link class="mr-5 hover:text-gray-900">hi</Link> */}
                    </nav>
